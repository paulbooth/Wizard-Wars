...
{
    public class HeavyArea : Area
    {

        public HeavyArea(Texture2D img, Vector2 pos, int power)
        ...
        public override void MakeEffects()
        {
            ...
            {
            effects.Add(new Particles(new Vector2(RNG.Next((int)pos.X, (int)(pos.X + dim.X)), pos.Y),
                        downarrows, 50));
