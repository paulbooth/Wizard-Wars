...
{
    class PortalWizard : Player
    {
        public PortalWizard(Texture2D img, List<Platform> starts, float power, int plnum)
        ...
        public override Projectile ability1()
        {
            if (firetime1.AddMilliseconds(300).CompareTo(DateTime.Now) < 0)
            {
                ...
                return new PortalBall(pos, getProjectileSpeed(),  power);
